...
public class RocketMQCollectTask extends AbstractCollectTask {
    ...
    protected Object getData() {
        ...
        if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.github.jgzl.bsf.mq.rocketmq.RocketMQConsumerProvider"), false) != null) {
            var hook = getCollectorHook("com.github.jgzl.bsf.mq.rocketmq.RocketMQMonitor");
        ...
        if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.github.jgzl.bsf.mq.rocketmq.RocketMQProducerProvider"), false) != null) {
            var hook = getCollectorHook("com.github.jgzl.bsf.mq.rocketmq.RocketMQMonitor");
