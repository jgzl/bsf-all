...
import com.github.jgzl.bsf.health.base.HealthException;
import lombok.Data;
import lombok.val;
...
public class JedisCollectTask extends AbstractCollectTask {
    ...
    protected Object getData() {
        val item = ContextUtils.getBean(ReflectionUtils.classForName("com.github.jgzl.bsf.redis.impl.RedisClusterMonitor"), false);
        if (item != null) {
            try {
