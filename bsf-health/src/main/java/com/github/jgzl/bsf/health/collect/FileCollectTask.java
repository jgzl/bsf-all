package com.github.jgzl.bsf.health.collect;
...
import com.github.jgzl.bsf.health.base.FieldReport;
import lombok.Data;
import lombok.var;
...
public class FileCollectTask extends AbstractCollectTask {
    ...
    protected Object getData() {
        ...
        if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.github.jgzl.bsf.file.impl.HotFileProvider"), false) != null) {
            data.provider = "hotfile";
        } else if (ContextUtils.getBean(ReflectionUtils.tryClassForName("com.github.jgzl.bsf.file.impl.QiniuFileProvider"),false) != null) {
            data.provider = "qiniu";
        }
        if (data.provider != null) {
            var hook = (Collector.Hook)ReflectionUtils.callMethod(ReflectionUtils.classForName("com.github.jgzl.bsf.file.impl.FileProviderMonitor"), "hook", null);
