...
import com.github.jgzl.bsf.file.config.HotFileProperties;
...
public class HotFileProvider extends AbstractFileProvider {
    ...
    @Override
    public String info() {
        return "hotfile:" + com.github.jgzl.bsf.core.util.StringUtils.nullToEmpty(uploadUrl);
    }
    ...
    private void sendWarning(){
        ...
        if(fileProperties.isWarningEnabled()){
            AbstractCollectTask.notifyMessage(EnumWarnType.ERROR,info(),"上传文件异常");
        }
    }
}
