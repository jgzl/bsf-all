package com.github.jgzl.bsf.cat;
        ...
        private String getSqlURL() {
            ...
            if (dataSource != null) {
                ...
                for (String cls:classs){
                    ...
                    Class<?> dataSourceClass = com.github.jgzl.bsf.core.util.ReflectionUtils.tryClassForName(clsName);
                    if(dataSourceClass!=null && dataSourceClass.isAssignableFrom(dataSource.getClass()))
                    {return com.github.jgzl.bsf.core.util.ReflectionUtils.tryCallMethod(dataSource,clsMethod,null,"");}
                }
