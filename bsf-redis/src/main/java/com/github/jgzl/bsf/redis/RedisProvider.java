...
public interface RedisProvider {
     ...
     *
     * @param key 锁的Key
     * @param timeout 锁的超时时间，单位：秒，小于等于0时不做限制
     * @return 返回redis锁对象
     */
     ...
     */
    boolean tryLock(String key, Runnable runnable);
     ...
     */
    <T> T tryLock(String key, Callable<T> callable);
     ...
     * @return 回调方法结果
     */
    <T> T lock(String key, Callable<T> callable);
